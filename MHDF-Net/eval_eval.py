...
from metrics_metrics import Metrics, accuracy

from classification_metrics_metrics import AVGMetrics
from tqdm import tqdm
from Mymodel import mymodel_MLDF as mymodel
import config
...
model = mymodel()
ckpt = torch.load(config.resume)
model.load_state_dict(state_dict=ckpt['net_state_dict'])
model = model.cuda()
_save_folder = config.metrics_dir
_metric_options = {
